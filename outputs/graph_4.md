...
classDiagram
    ...
    %% LLD Actions
        ...
        class LLD_101["LLD_101: 単品の32Dセンターフロアの精度を測定する"] {
            Input: no input
            Output: 測定結果：
１：単品の①②③面精度が悪い
２：基準Ⅰ、Ⅱの穴径精度が悪い
        ...
        class LLD_102["LLD_102: 32Dセンターフロアの不具合を判断する"] {
            Input: 測定結果：
１：単品の①②③面精度が悪い
２：基準Ⅰ、Ⅱの穴径精度が悪い
            Output: 不具合：
...
・基準Ⅰ、Ⅱの穴径精度不良
        ...
        class LLD_103["LLD_103: 解決したい不具合を選ぶ"] {
            Input: 不具合：
・中央部は自重ダレ、左右端部は自重ダレに伴う変形がある
・基準Ⅰ、Ⅱの穴径精度不良
            Output: 選択された不具合：
基準Ⅰ、Ⅱの穴径精度不良、基準Ⅰ、Ⅱの穴径を改修前の単品の32Dセンターフロア図面
        }
        

        class LLD_105["LLD_105: 改修した金型で単品の32Dセンターフロアをプレスする"] {
            Input: 穴径を改修後の単品の
32Dセンターフロア図面
            Output: プレスした単品の32Dセンターフロア
        }
        

        class LLD_107["LLD_107: 単品の32Dセンターフロアの金型改修が前後工程への影響を調べる"] {
            Input: 穴径の精度：公差のプラス・マイナス0.１以内
            Output: 影響なし
        }
        

        class LLD_108["LLD_108: 単品の32Dセンターフロアの金型改修のコストを調べる"] {
            Input: 影響なし
            Output: コストOK
        }
        

        class LLD_109["LLD_109: 解決したい不具合を選ぶ"] {
            Input: コストOK
            Output: 選択された不具合：
中央部は自重ダレ、
左右端部は自重ダレに伴う変形がある
        ...
        class LLD_110["LLD_110: 不具合発生の原因を推定する"] {
            Input: 選択された不具合：
中央部は自重ダレ、
左右端部は自重ダレに伴う変形がある
            Output: 推定した原因：
...
部品お基準設定に関係する
        ...
        class LLD_111["LLD_111: 32Dセンターフロアの基準数が足りるかを調べる"] {
            Input: 推定した原因：
自重ダレによる変形の発生は
部品お基準設定に関係する
            Output: 足りていない基準数量：2個
足りていない基準の位置：
位置①
位置②
        }
        ...
        class LLD_112["LLD_112: 単品の32Dセンターフロアの基準追加位置を決める"] {
            Input: 足りていない基準数量：2個
足りていない基準の位置：
位置①
位置②
...
32Dセンターフロア
        ...
        class LLD_113["LLD_113: 決めた位置に基準を追加する"] {
            Input: 基準追加位置：Ⅲm、Ⅲ１
基準追加前の単品
32Dセンターフロア
            Output: 基準追加後の単品32Dセンターフロア
        }
        

        class LLD_114["LLD_114: 単品の32Dセンターフロアに治具をセットする"] {
            Input: 基準追加後の単品32Dセンターフロア
            Output: 治具が設置した単品の32Dセンターフロア
        }
        

        class LLD_115["LLD_115: 単品の32Dセンターフロアの精度を測定する"] {
            Input: 治具が設置した単品の32Dセンターフロア
            Output: 精度：〇〇
        }
        

        class LLD_116["LLD_116: 単品の32Dセンターフロアに基準追加による不具合が解消したかを評価する"] {
            Input: 精度：〇〇
            Output: 不具合が解消した
        }
        

        class LLD_117["LLD_117: 単品の32Dセンターフロアの基準追加案が前後工程への影響を調べる"] {
            Input: 不具合が解消した
            Output: 影響なし
        }
        

        class LLD_118["LLD_118: 単品の32Dセンターフロアの基準追加案が前後工程へのコストを調べる"] {
            Input: 影響なし
            Output: コストOK
        }
        

        class LLD_119["LLD_119: 単品の32Dセンターフロアに基準追加する"] {
            Input: コストOK
            Output: no output
        }
        

        class LLD_120["LLD_120: 測定により単品の32Dセンターフロアが不具合がないかを調べる"] {
            Input: no input
            Output: 不具合なし
        }
...
LLD_119 --> LLD_120
    ...
    %% LLD-GPM Edges
LLD_101 <|.. GPM_1 : Implements
LLD_102 <|.. GPM_3 : Implements
LLD_103 <|.. GPM_53 : Implements
LLD_105 <|.. GPM_42 : Implements
LLD_107 <|.. GPM_17 : Implements
LLD_108 <|.. GPM_18 : Implements
LLD_109 <|.. GPM_53 : Implements
LLD_110 <|.. GPM_4 : Implements
LLD_111 <|.. GPM_29 : Implements
LLD_112 <|.. GPM_30 : Implements
LLD_113 <|.. GPM_31 : Implements
LLD_114 <|.. GPM_54 : Implements
LLD_115 <|.. GPM_52 : Implements
LLD_116 <|.. GPM_55 : Implements
LLD_117 <|.. GPM_17 : Implements
LLD_118 <|.. GPM_18 : Implements
LLD_119 <|.. GPM_31 : Implements
LLD_120 <|.. GPM_55 : Implements
